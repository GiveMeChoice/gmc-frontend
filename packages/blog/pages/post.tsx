...
import PostSidebarRelatedPost from '../components/PostSidebarRelatedPost';
                ...
                <>
                  <article>
                    ...
                    <div className="flex w-full">
                      <div className="flex max-w-[770px] flex-col">
                        <CoverImage
                          title={post.title}
                          image={post.coverImage}
                          priority
                        />
                        <div className="gap-y-4 pl-2 pr-9 pt-8">
                          ...
                          {post.content2 && (
                            <PostBody content={post.content2} />
                          )}
                        </div>
                      </div>
                      <div className="flex justify-center px-12 pt-10">
                        <div className="flex max-w-[300px] flex-col gap-y-4 divide-y-1.5 divide-secondary-dark-10">
                          ...
                          {morePosts.slice(0, 4).map((post) => (
                            <PostSidebarRelatedPost post={post} />
                          ))}
                          <div className="w-full">AD</div>
                          <div className="w-full">SUBSCRIBE</div>
                        </div>
                      </div>
                    </div>
                  </article>
