...
const LabelFilters: React.FC<Props> = ({ onFieldChange }) => {
    ...
    <div className="flex w-full flex-col gap-y-2">
      <div className="flex w-full">
        <div className="mr-2 w-3/4">
          ...
          <select
            ...
            className={cn(
              ...
              {
                'text-gray-400': !activeFilters.gmcLabelId,
              }
            )}
            disabled={activeFilters.labelUnassigned}
            value={activeFilters.gmcLabelId}
        ...
        <div className="flex h-full w-1/4 flex-col items-center justify-center">
          ...
          <input
            type="checkbox"
            id="labelUnassigned"
            checked={activeFilters.labelUnassigned}
            onChange={() => {
              filtersDispatch({
                type: 'FILTERS_SAVE',
                value: {
                  ...activeFilters,
                  gmcLabelId: '',
                  labelUnassigned: !activeFilters.labelUnassigned,
                },
              });
            }}
      ...
      <div className="w-full">
        ...
        <input
          ...
          value={activeFilters.merchantLabelCode}
          onChange={onFieldChange}
        />
      </div>
    </div>
