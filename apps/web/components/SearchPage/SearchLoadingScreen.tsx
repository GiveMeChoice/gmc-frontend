...
const SearchLoadingScreen: React.FC = () => {
  return (
    <div className="background-animate boder-1.5 flex h-screen flex-col items-center justify-evenly rounded-sm border-zinc-800 bg-gmc-surf from-gmc-surf via-primary to-gmc-sunset pb-24">
      <LoadingMarquee />
