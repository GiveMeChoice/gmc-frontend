...
const ShopEntityListItem: React.FC<Props> = ({
  ...
  return level === ShopEntityListLevel.A ||
    ...
    <div
      onClick={handleClick}
      className={cn(
        'group flex min-h-[28px] w-full items-center gap-x-2 hover:cursor-pointer',
        {
    ...
    >
      <div
        ...
        className={cn('h-0 w-2.5 rounded-full', {
          'group-hover:h-2.5 group-hover:w-2.5': !isSelected,
          'h-2.5 w-2.5': isSelected,
        })}
      />
