...
const BlogNavbarDropdownPost: React.FC<Props> = ({ post, onNavigate }) => {
  return (
    <div className="flex h-full w-full flex-col divide-y-1.5 divide-secondary-dark-10">
      ...
      <div className="flex h-[320px] w-full flex-grow flex-col gap-y-[15px] overflow-y-hidden bg-black p-6 text-white xl:h-[300px]">
        ...
        <h4 className="cursor-pointer text-[22px] font-bold hover:text-zinc-300 active:text-primary">
