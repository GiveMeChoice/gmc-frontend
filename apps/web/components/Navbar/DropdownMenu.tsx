...
const DropdownMenu: React.FC<Props> = ({ closeMenu, open }) => {
  ...
  return (
    <div
      id="dropdown-menu"
      className={cn(
        `dropdown-menu absolute -right-2 z-50 w-[365px] -translate-y-[30px] overflow-hidden rounded-2xl border-1.5 border-zinc-600 bg-white shadow-md duration-300 ease-in-out`,
        {
