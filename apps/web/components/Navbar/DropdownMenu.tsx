...
const DropdownMenu: React.FC<Props> = ({ closeMenu, open }) => {
  ...
  return (
    <div
      id="dropdown-menu"
      className={cn(
        `transition-height absolute z-50 max-h-fit w-96 max-w-full overflow-hidden rounded-sm border border-zinc-700 bg-secondary shadow-sm shadow-zinc-700 duration-300 ease-in-out bg-${
