...
const SearchMarquee: React.FC = () => {
  return (
    <div className="background-animate relative flex h-12 w-full overflow-x-hidden border-t-1.5 border-zinc-700 bg-gmc-sunset from-gmc-ocean-light-40 via-secondary to-gmc-surf text-[18px]">
