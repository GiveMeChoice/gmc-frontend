...
import ComparableProductDescription from './ComarableProductDescription';
import ComparableProductLabels from './ComarableProductLabels';
import ComparableProductBuyBox from './ComparableProductBuyBox';
import ComparableProductHeading from './ComparableProductHeading';
import ComparableProductImages from './ComparableProductImages';
